...
function formatTransitionLabel(transition) {
    ...
    const id = getTransitionId(transition).trim();
...
export default class LegendProvider {
    ...
    _getPlaces() {
        return this._elementRegistry
            ...
            .sort((a, b) => {
                const aNum = getPlaceId(a);
                const bNum = getPlaceId(b);
    ...
    _getTransitions() {
        return this._elementRegistry
            ...
            .sort((a, b) => {
                const aNum = getTransitionId(a);
                const bNum = getTransitionId(b);

                if (aNum !== bNum) {
                    return aNum - bNum;
                }

                return getTransitionId(a).localeCompare(getTransitionId(b));
            });
    }
