...
// Stub kept for call-site compatibility; query rows are now handled via row binding, not guard variables.
function buildQueryVariableTypeMap(_transition) {
  return new Map();
}
...
function buildPromptMessage(inputVariableTypes, outputVariableTypes, _queryVariableTypes = new Map()) {
