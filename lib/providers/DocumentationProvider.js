...
<ul>
  ...
  <li>Actions are intentionally powerful: they can irreversibly modify the loaded database. However, changes are only applied to the .db file on disk when the user actively exports either the .db or .dbpnml file.</li>
</ul>
