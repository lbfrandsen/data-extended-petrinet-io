...
export default class CustomContextPadProvider {
  ...
  constructor(eventBus, connect, contextPad, modeling, elementFactory, create, popupMenu, idCounterService, selection, simulationService, directEditing, placeTypingProvider, sqlDialogService) {
    ...
    if (element.type === 'petri:place') {
        ...
        entries.clearTokens = {
          ...
          action: {
            click: () => {
              ...
              element.businessObject.tokens = 0;
      ...
      entries.place = {
        ...
        entries.setGuard = {
          ...
          action: {
            click: () => {
              promptAndSetGuard(element, this.eventBus, this.sqlDialogService);
            }
          }
        },
        entries.setSqlQuery = {
