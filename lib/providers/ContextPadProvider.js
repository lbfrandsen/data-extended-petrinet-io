...
import { promptAndSetArcInscription } from '../providers/ArcInscriptionProvider.js';
export default class CustomContextPadProvider {
  ...
  getContextPadEntries(element) {
    ...
    const createAdjacent = (type) => {
      ...
      modeling.createConnection(element, created, { type: 'petri:connection', id: this.idCounterService.getNextConnectionId() }, parent);
