          ...
          const selectButton = createButton(
            ...
            async () => {
              ...
              queryRowRefs.forEach((ref, queryId) => {
                ...
                ref.row.style.border = active ? '1px solid #1976d2' : '1px solid #e0e0e0';
                ref.row.style.background = active ? '#f2f8ff' : '#fafafa';
                ref.button.textContent = active ? 'Detach' : 'Attach';
                ref.button.style.background = active ? '#f5f5f5' : '#1976d2';
                ref.button.style.color = active ? '#222' : '#fff';
                ref.button.style.border = active ? '1px solid #ccc' : '1px solid #1976d2';
              });
            },
          ...
          const selectButton = createButton(
            ...
            async () => {
              ...
              actionRowRefs.forEach((ref, actionId) => {
                ...
                ref.row.style.border = selectedNow ? '1px solid #1976d2' : '1px solid #e0e0e0';
                ref.row.style.background = selectedNow ? '#f2f8ff' : '#fafafa';
                ref.button.textContent = selectedNow ? 'Detach' : 'Attach';
                ref.button.style.background = selectedNow ? '#f5f5f5' : '#1976d2';
                ref.button.style.color = selectedNow ? '#222' : '#fff';
                ref.button.style.border = selectedNow ? '1px solid #ccc' : '1px solid #1976d2';
              });
            },
