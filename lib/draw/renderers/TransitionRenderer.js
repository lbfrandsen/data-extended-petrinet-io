...
export function drawTransition(parentGfx, element, styles, simulationService, eventBus) {
  ...
  drawGuardText(parentGfx, element, width, height, eventBus);

  return rect;
}

// Renders the transition guard text.
function drawGuardText(parentGfx, element, width, height, eventBus) {
  ...
  text.addEventListener('dblclick', event => {
    ...
    promptAndSetGuard(element, eventBus);
  });
