...
import { drawPlace, getPlacePath } from './renderers/PlaceRenderer.js';
import { drawTransition, getTransitionPath } from './renderers/TransitionRenderer.js';
import { createArrowMarker } from './helpers/ConnectionRenderer.js';

const HIGH_PRIORITY = 1500;

export default class CustomRenderer extends BaseRenderer {
  static $inject = ["eventBus", "styles", "connectionDocking", "simulationService", "idCounterService", "sqlDialogService"];

  constructor(eventBus, styles, connectionDocking, simulationService, idCounterService, sqlDialogService) {
  ...
  drawShape(parentGfx, element) {
    ...
    if (type === "petri:place") {
      ...
      shape = drawTransition(
        parentGfx,
        element,
        this.styles,
        this.simulationService,
        this.eventBus,
        this.sqlDialogService
      );
    }
