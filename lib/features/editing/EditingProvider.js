...
export default class EditingProvider {
  ...
  async addTokenPopup(place) {
    ...
    place.businessObject.place_type = placeTypeUtils.getRawPlaceType(place.businessObject);
    ...
    if (typeKey === null || typeKey === undefined) {
      showAlert({
        ...
        message: 'This place has no type. Create the place again or add typing first.'
      });
      return;
    }
