...
export default class PnmlImporter {
    ...
    static $inject = ["canvas", "elementFactory", "elementRegistry", "modeling", "idCounterService", "simulationService"]

    constructor(canvas, elementFactory, elementRegistry, modeling, idCounterService, simulationService) {
        this.canvas = canvas;
