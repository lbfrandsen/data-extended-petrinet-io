...
import { isTransitionEnabled } from '../simulation/BaseSimulationService.js';

export default class PnmlImporter {

    static $inject = ["canvas", "elementFactory", "elementRegistry", "modeling", "idCounterService", "simulationService", "sqlDialogService"]

    constructor(canvas, elementFactory, elementRegistry, modeling, idCounterService, simulationService, sqlDialogService) {
        this.canvas = canvas;
